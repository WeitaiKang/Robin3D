...
parser.add_argument('--max_inst_num', type=int, default=100)
...
for split in ["test"]:
    ...
    split_path = f"/data/kangweitai/3D/scannet/meta_data/scannetv2_{split}.txt"
    ...
    for scan_id in tqdm(scan_ids):
        ...
        for i in range(num_insts): # min(num_insts, args.max_inst_num)
        ...
        # print(f'--- scan_id: {scan_id}, inst_locs: {inst_locs.shape}')
        scans[scan_id] = {
