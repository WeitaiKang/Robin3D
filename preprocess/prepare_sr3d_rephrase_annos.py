...
for split in ["train"]:
    ...
    #                 'description': row['utterance']
    #             })
    raw_annos = json.load(open(f"/data/kangweitai/3D/annotation/gpt_rephrase/sr3d+_train_rephrase_merged.json"))
    ...
    print(f'--- new sr3d+_{segmentor}_{split}{version}_rephrase.json has {len(new_annos)} annotations ---')
    save_path = os.path.join(args.save_dir, f"sr3d+_{segmentor}_{split}{version}_rephrase.json")
