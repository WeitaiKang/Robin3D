...
for split in ["train"]:
    ...
    save_path = os.path.join(args.save_dir, f"nr3d_caption_{segmentor}_{split}{version}.json")
    print(f'--- new nr3d_caption_{segmentor}_{split}{version}.json has {len(new_annos)} annotations ---')
