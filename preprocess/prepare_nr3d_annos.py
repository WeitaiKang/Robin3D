...
for split in ["val"]: # "train"
    ...
    # print(len(new_annos))
    print(f'--- new nr3d_{segmentor}_{split}{version}.json.json has {len(new_annos)} annotations ---')
    ...
    save_path = os.path.join(args.save_dir, f"nr3d_{segmentor}_{split}{version}.json")
